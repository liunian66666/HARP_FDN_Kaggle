...
class Model(nn.Module):
    ...
    This version keeps the HARP probabilistic decoding story and strengthens
    the support-logit generator with an input-conditioned multi-scale patch
    mixer. It is aimed at the next reduction target after HARP_FDN_X.
    """
