...
run_cfg() {
  ...
  echo "===== $(date '+%F %T') START ${tag} lr=${lr} msew=${msew} fuw=${fuw} cls=${cls} strength=${strength} con_time=${con_time} =====" | tee "$log"
  python -u run.py \
    --is_training 1 \
...
run_cfg V4_HCM_A_lr88_mix9_s355_fuw0975_cls095 0.00088 9.0 0.975 0.095 -3.55 0.1
run_cfg V4_HCM_A_lr92_mix9_s355_fuw0975_cls095 0.00092 9.0 0.975 0.095 -3.55 0.1
run_cfg V4_HCM_A_lr90_mix85_s355_fuw0975_cls095 0.00090 8.5 0.975 0.095 -3.55 0.1
run_cfg V4_HCM_A_lr90_mix95_s355_fuw0975_cls095 0.00090 9.5 0.975 0.095 -3.55 0.1
