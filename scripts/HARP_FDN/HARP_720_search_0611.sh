...
run_720() {
  local tag="$1" lr="$2" msew="$3" rel="$4" cond="$5" rs="$6" hcm="$7" strength="$8" maxgate="$9"
...
run_720 RERUN720_V4_lr94_mix9_fullHCM 0.00094 9.0 1 1 1 1 -3.55 0.08
run_720 RERUN720_V4_lr10_mix2_interlike_noHCM 0.00010 2.0 0 0 0 0 -5.0 0.04
run_720 RERUN720_V4_lr20_mix4_rel_noHCM 0.00020 4.0 1 1 1 0 -5.0 0.04
run_720 RERUN720_V4_lr50_mix8_weakHCM 0.00050 8.0 1 1 1 1 -5.0 0.04
