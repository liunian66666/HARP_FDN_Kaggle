...
run_test() {
  ...
  python -u run.py \
    ...
    --model_id LITE720_LIN_A_mae_lr1e3_sigmoid --model HARP_FDN_PCX_Lite --data ETTh1 --features M \
    ...
    --val_candidate_blend_modes last,ma4,ma12,ma24,ma48,linear4,linear8,drift4,drift8 \
...
run_test LITE720_LIN_A_calib_scalar scalar 0
run_test LITE720_LIN_A_calib_horizon horizon 0
run_test LITE720_LIN_A_calib_element element 0
run_test LITE720_LIN_A_calib_affine_element element 1
