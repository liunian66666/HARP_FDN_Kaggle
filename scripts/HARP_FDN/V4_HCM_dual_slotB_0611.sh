...
run_cfg() {
  ...
  echo "===== $(date '+%F %T') START ${tag} fuw=${fuw} cls=${cls} strength=${strength} =====" | tee "$log"
  python -u run.py \
    --is_training 1 \
...
run_cfg V4_HCM_B_s3525_fuw0975_cls095 0.975 0.095 -3.525
run_cfg V4_HCM_B_s3575_fuw0975_cls095 0.975 0.095 -3.575
run_cfg V4_HCM_B_s355_fuw0970_cls095 0.970 0.095 -3.55
run_cfg V4_HCM_B_s355_fuw0980_cls095 0.980 0.095 -3.55
run_cfg V4_HCM_B_s355_fuw0975_cls094 0.975 0.094 -3.55
run_cfg V4_HCM_B_s355_fuw0975_cls096 0.975 0.096 -3.55
