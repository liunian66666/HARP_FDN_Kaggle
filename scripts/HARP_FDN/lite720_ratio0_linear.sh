...
run_one() {
  local tag="$1" lr="$2" obj="$3" msew="$4" lradj="$5" nlin="$6"
...
run_one LITE720_LIN_R0_A_mix1_lr1e3 0.001 mix 1.0 sigmoid -1.0
run_one LITE720_LIN_R0_B_mse_lr1e3 0.001 mse 1.0 sigmoid -1.0
run_one LITE720_LIN_R0_C_mix2_lr7e4 0.0007 mix 2.0 sigmoid -1.0
