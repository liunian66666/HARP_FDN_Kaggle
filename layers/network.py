"""
Copyright (c) 2025 [Linghao Kong, Xiaopeng Hong]
[(AAAI 2026) Official implementation of "Time Series Forecasting via Direct Per-Step Probability Distribution Modeling]

This code is based on xPatch: Dual-Stream Time Series Forecasting with Exponential Seasonal-Trend Decomposition
- Paper: Proceedings of the AAAI Conference on Artificial Intelligence, 2025
- Authors: Artyom Stitsyuk, Jaesik Choi
- Code Repository: https://github.com/stitsyuk/xPatch
...
This code retains the original copyright notice as required by the source license.
"""
